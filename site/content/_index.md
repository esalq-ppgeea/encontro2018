...
O Encontro dos Alunos em Estatística e Experimentação Agronômica é um
evento do programa de pós-graduação em Estatística e Experimentação na
Escola Superior de Agricultura Luiz de Queiroz da Universidade de São
Paulo (ESALQ-USP) que ocorre com periodicidade anual. Sua primeira
edição foi realizada em 2010, sob organização da profº Clarice Demétrio
junto com outros professores do departamento.
...
* Idemauro Antonio Rodrigues de Lara (ESALQ/USP);
* Rafael de Andrade Moral (Maynooth University);
* Renata Alcarde (ESALQ/USP);
* Thiago Oliveira de Paula (ESALQ/USP);
* Walmes Marques Zeviani (LEG/UFPR);

<!--html_preserve-->
<a target="_blank" href="https://raw.githubusercontent.com/esalq-ppgeea/encontro2018/master/divulgacao/cartaz.png">
    <img
    src="https://raw.githubusercontent.com/esalq-ppgeea/encontro2018/master/divulgacao/cartaz.png"
    alt="Cartaz do evento" width="600" height="100%">
</a>
<!--/html_preserve-->
